...
import { setErrors, setPending, setSuccess } from "shared/lib/utils";
...
>("users/getUsers", async function ({ currentPage, pageSize }, { dispatch }) {
...
export const follow = createAsyncThunk<
  ...
  number,
  { dispatch: RootDispatch }
>("users/follow", async function (userId, { dispatch }) {
